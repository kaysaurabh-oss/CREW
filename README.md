...
Initial users are seeded from `data/initial_users.csv`. Admin and office pilot accounts are also auto-repaired on startup so you do not get locked out during testing. Change all passwords before live rollout.
